<div class="widget-first widget recent-posts">
    <h3>{{ Lang::get('ru.latest_projects') }}Recent Posts</h3>
        ...
        <div class="hentry-post group">
            ...
            @if(!$portfolios->isEmpty())
                @foreach($portfolios as $portfolio)
                    ...
                    <div class="text">
                        <a href="{{ route('portfolios.show', ['alias' => $portfolio->alias]) }}" title="{{ $portfolio->title }}Section shortcodes &amp; sticky posts!" class="title">Section shortcodes &amp; sticky posts!</a>
