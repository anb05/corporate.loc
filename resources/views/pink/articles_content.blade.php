        ...
        @foreach($articles as $article)
            ...
            <div class="sticky hentry hentry-post blog-big group">
                ...
                <div class="thumbnail">
                    ...
                    <p class="date">
                        <span class="month">{{ $article->created_at->format('M') }}Sep</span>
                        <span class="day">{{ $article->created_at->format('d') }}24</span>
                    </p>
                </div>
                <!-- post meta -->
                ...
                <div class="the-content group">
                    {!! $article->desc !!}
                    <p><a href="{{ route('articles.show', ['alias' => $article->alias]) }}article.html" class="btn   btn-beetle-bus-goes-jamba-juice-4 btn-more-link">>{{ Lang::get('ru.read_more') }}</a></p>
                </div>
                <div class="clear"></div>
            </div>
