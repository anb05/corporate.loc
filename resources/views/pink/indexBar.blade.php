        ...
        <div class="recent-post group">
            @foreach($articles as $article)
                <div class="hentry-post group">
                    ...
                    <div class="text">
                        <a href="{{ route('articles.show', ['alias' => $article->alias]) }}article.html" title="Section shortcodes &amp; sticky posts!" class="title">{{ $article->title }}Section shortcodes &amp; sticky posts!</a>
